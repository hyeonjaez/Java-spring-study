...
<ul>
    <c:forEach var="category" items="${categoryList}">
        <li><a href="/index.do?categoryNumber=${category.categoryId}"><em><strong>${category.categoryName}</strong></em></a></li>
    </c:forEach>
</ul>
...
<div class="pagination">
    <c:forEach var="page" begin="1" end="${productPage.totalPage}">
        <c:choose>
            ...
            <c:otherwise>
                <a href="/index.do?categoryNumber=${categoryNumber}&pageNumber=${page}">${page}</a>
            </c:otherwise>
        </c:choose>
    </c:forEach>
</div>
